    ...
    def instance(iid):
        try:
            ...
            if res:
                ...
                _instance['build_outcomes'] = {el.id: el for el in instance_handler.get_compile_outcome(iid)}
                _instance['test_outcomes'] = {el.id: el for el in instance_handler.get_test_outcome(iid)}
